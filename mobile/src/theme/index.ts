// src/theme/index.ts
// Design tokens centralizados — nunca hardcodar cor/espaçamento inline
...
export const statusDimColor: Record<string, string> = {
  pending: colors.yellowDim,
  in_progress: colors.accentDim,
  done: colors.greenDim,
};
